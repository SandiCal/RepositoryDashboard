...
# This dashboard analyzes repository metrics provided by the Illinois Data Bank in csv format. See https://databank.illinois.edu/metrics for sample metrics files and a description of the variables included.
